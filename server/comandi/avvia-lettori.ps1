...
$lettori = @(
  ...
  # LA SPAGNA VA TENUTA D'OCCHIO, ED E' L'UNICA.
  # Il 23 settembre l'ho spenta perche' Alcampo rispondeva «bloccato» anche a
  # UNA pagina ogni tre secondi: il lettore aveva aperto 1.222 pagine per 12
  # prezzi, cioe' insisteva con qualcuno che aveva gia' detto di no — e l'API
  # la rivende un cliente, quindi la lamentela arriva a lui.
  #
